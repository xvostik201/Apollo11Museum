...
{
    [Header("Scenario")]
    [SerializeField] private BaseMuseumExhibit _museumExhibit;
    ...
    private void Start()
    {
        ...
        _name.text = _museumExhibit.Name;
        _description.text = _museumExhibit.HistoryDescription;
    ...
    {
        _museumExhibit.OnScenarioComplete += AnimateActiveText;
    ...
    private void Update()
    {
        ...
        if (_inTrigger && Input.GetKeyDown(KeyCode.E) && _museumExhibit.Interectable)
        {
            if (!_museumExhibit.IsScenarioActive)
            {
                _museumExhibit.ActivateScenario();
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        Debug.Log($"Зашли в сценарий: {_museumExhibit.Name}. Hажмите 'E', чтобы начать");
    }
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        Debug.Log($"Вышли из сценария: {_museumExhibit.Name}");
    }
